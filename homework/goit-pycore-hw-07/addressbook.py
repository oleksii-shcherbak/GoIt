...
class Phone(Field):
    """Represents a contact's phone number. Validates 10-digit numeric format."""
...
class Record:
    """Stores contact information: name, list of phones, and optional birthday."""
...
def input_error(func):
    """
    Decorator for handling common input-related errors and returning user-friendly messages.
    """
